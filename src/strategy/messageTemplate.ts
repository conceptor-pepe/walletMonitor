import { formatTimeAgo } from '../utils/txsAnalyzer';
...
interface WalletData {
  walletName: string;
  totalBuyCost: string | number;
  averageMarketCap: string | number;
  buyTime: string;
  holdsPercentage: string;
}

function formatSmartMoney(analysis: Record<string, WalletData>) {
  let details = '';
...
export function createMsg(tokenInfo: any, analysis: any) {
